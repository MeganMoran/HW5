<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="newpuppy.aspx.vb" Inherits="detailsview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" 
        AutoGenerateRows="False" DataKeyNames="puppyID" DataSourceID="SqlDataSource2" 
        Height="50px" Width="477px" DefaultMode="Insert">
        <Fields>
